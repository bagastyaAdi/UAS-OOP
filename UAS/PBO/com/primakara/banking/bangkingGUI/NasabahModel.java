...
public class NasabahModel {
    ...
    public void insertNasabah(com.primakara.banking.Nasabah nasabah) {
    ...
    public List<com.primakara.banking.Nasabah> getAllNasabah() {
        List<com.primakara.banking.Nasabah> nasabahList = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                com.primakara.banking.Nasabah nasabah = new Nasabah(
                        rs.getInt("NIK"),
                        rs.getInt("Kode_CIF"),
